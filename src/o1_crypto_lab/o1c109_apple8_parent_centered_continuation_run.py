"""Burn-on-intent runner for the single O1C-0109 Page-22 call.

The runner has one scientific side effect: after an immutable intent is
persisted it may invoke native v33 once, with seed zero and 128 requested
...
the published, sealed O1C-0108 type-safe causal-rollover bundle; it never regenerates
...
ACTIVE_PROJECTION_NAME = _o1c108.ACTIVE_PROJECTION_NAME
ACTIVATION_LEDGER_NAME = _o1c108.ACTIVATION_LEDGER_NAME
ATTIC_CHUNK_COUNT = _o1c108.ATTIC_CHUNK_COUNT
ATTIC_OCCURRENCE_COUNT = _o1c108.ATTIC_OCCURRENCE_COUNT
ATTIC_SUBSUMPTION_RELATION_COUNT = _o1c108.ATTIC_SUBSUMPTION_RELATION_COUNT
ATTIC_UNDOMINATED_CLAUSE_COUNT = _o1c108.ATTIC_UNDOMINATED_CLAUSE_COUNT
ATTIC_UNION_CLAUSE_COUNT = _o1c108.ATTIC_UNION_CLAUSE_COUNT
COMMON_CORE_AUDIT_NAME = _o1c108.COMMON_CORE_AUDIT_NAME
COMBINED_KNOWN_INVENTORY_SHA256 = _o1c108.LOGICAL_KNOWN_INVENTORY_SHA256
DEFAULT_PARENT_CAPSULE_RELATIVE = _o1c108.DEFAULT_PARENT_CAPSULE_RELATIVE
DEFAULT_PARENT_RESULT_RELATIVE = _o1c108.DEFAULT_PARENT_RESULT_RELATIVE
DERIVED_CLOSURE_BYTES = _o1c108.DERIVED_CLOSURE_BYTES
DERIVED_CLOSURE_NAME = _o1c108.DERIVED_CLOSURE_NAME
DERIVED_CLOSURE_SHA256 = _o1c108.DERIVED_CLOSURE_SHA256
DERIVED_KNOWN_INVENTORY_SHA256 = _o1c108.DERIVED_CLOSURE_INVENTORY_SHA256
DERIVED_RECEIPT_BYTES = _o1c108.DERIVED_RECEIPT_BYTES
DERIVED_RECEIPT_NAME = _o1c108.DERIVED_RECEIPT_NAME
DERIVED_RECEIPT_SHA256 = _o1c108.DERIVED_RECEIPT_SHA256
DERIVED_OVERLAY_BYTES = _o1c108.DERIVED_CLOSURE_BYTES
DERIVED_OVERLAY_NAME = _o1c108.DERIVED_OVERLAY_NAME
DERIVED_OVERLAY_SHA256 = _o1c108.DERIVED_CLOSURE_SHA256
EMITTED_KNOWN_INVENTORY_SHA256 = (
    "987802e397731e97a54abb278f31ff6dbf9b11bd8834cbc18297c87f2da5ff21"
)
CONTINUATION_BANK_BYTES = _o1c108.FINAL_BANK_BYTES
CONTINUATION_BANK_SHA256 = _o1c108.FINAL_BANK_SHA256
PREPARED_CONTINUATION_BANK_NAME = _o1c108.FINAL_BANK_NAME
LOGICAL_KNOWN_CLAUSE_COUNT = _o1c108.LOGICAL_KNOWN_CLAUSE_COUNT
LOGICAL_KNOWN_SHA256 = _o1c108.LOGICAL_KNOWN_SHA256
NEW_CHUNK_NAME = _o1c108.NEW_CHUNK_NAME
NEW_CHUNK_SERIALIZED_BYTES = _o1c108.NEW_CHUNK_SERIALIZED_BYTES
NEW_CHUNK_SHA256 = _o1c108.NEW_CHUNK_SHA256
OCCURRENCES_NAME = _o1c108.OCCURRENCES_NAME
OCCURRENCE_DOCUMENT_BYTES = _o1c108.OCCURRENCE_BYTES
OCCURRENCE_DOCUMENT_SHA256 = _o1c108.OCCURRENCE_SHA256
PAGE22_ACTIVE_LIMIT = _o1c108.PAGE22_ACTIVE_LIMIT
PAGE22_ACTIVATION_DOCUMENT_BYTES = _o1c108.ACTIVATION_BYTES
PAGE22_ACTIVATION_DOCUMENT_SHA256 = _o1c108.ACTIVATION_SHA256
PAGE22_CATEGORY_COUNTS: Mapping[str, int] = {
    "emitted_hot_event": 0,
...
PAGE22_CLAUSE_COUNT = _o1c108.PAGE22_ACTIVE_LIMIT
PAGE22_HEADROOM: Mapping[str, int] = {
    "clauses": 266,
    "literals": 911_167,
    "serialized_bytes": 5_632_101,
}
PAGE22_LITERAL_COUNT = _o1c108.PAGE22_LITERAL_COUNT
PAGE22_RESIDENCY_DOCUMENT_BYTES = _o1c108.RESIDENCY_BYTES
PAGE22_RESIDENCY_DOCUMENT_SHA256 = _o1c108.RESIDENCY_SHA256
PAGE22_SERIALIZED_BYTES = _o1c108.PAGE22_SERIALIZED_BYTES
PAGE22_SHA256 = _o1c108.PAGE22_SHA256
PURE_EMITTED_CANDIDATE_SHA256 = _o1c108.PAGE22_PURE_EMITTED_SHA256
PARENT_CAPSULE_MANIFEST_SHA256 = _o1c108.PARENT_CAPSULE_MANIFEST_SHA256
PARENT_RESULT_SHA256 = _o1c108.PARENT_RESULT_SHA256
PARENT_INTENT_SHA256 = _o1c108.PARENT_INTENT_SHA256
PREPARATION_MANIFEST_NAME = _o1c108.PREPARATION_MANIFEST_NAME
PREPARATION_MANIFEST_BYTES = _o1c108.PREPARATION_MANIFEST_BYTES
PREPARATION_MANIFEST_SHA256 = _o1c108.PREPARATION_MANIFEST_SHA256
PREPARATION_SCHEMA = _o1c108.PREPARATION_SCHEMA
PRIORITY_RECEIPT_NAME = _o1c108.PRIORITY_RECEIPT_NAME
PRIORITY_RECEIPT_BYTES = _o1c108.PRIORITY_RECEIPT_BYTES
PRIORITY_RECEIPT_SHA256 = _o1c108.PRIORITY_RECEIPT_SHA256
RELATIONS_NAME = _o1c108.RELATIONS_NAME
RELATION_DOCUMENT_BYTES = _o1c108.RELATION_BYTES
RELATION_DOCUMENT_SHA256 = _o1c108.RELATION_SHA256
RESIDENCY_NAME = _o1c108.RESIDENCY_NAME
CERTIFICATION_AUDIT_NAME = _o1c108.CERTIFICATION_AUDIT_NAME
CERTIFICATION_AUDIT_BYTES = _o1c108.CERTIFICATION_AUDIT_BYTES
CERTIFICATION_AUDIT_SHA256 = _o1c108.CERTIFICATION_AUDIT_SHA256
...
NATIVE_BUILD_SCHEMA = "o1-256-o1c109-native-v33-build-v2"
...
CONFIG_RELATIVE = Path("configs/o1c109_apple8_parent_centered_continuation_v1.json")
RESULT_RELATIVE = Path(
    "research/O1C0109_APPLE8_PARENT_CENTERED_CONTINUATION_RESULT_20260721.json"
)
CAPSULE_SUFFIX = "O1C-0109_apple8-parent-centered-continuation-v1"

LOCAL_EPISODE_ORDINAL = 0
LINEAGE_CALL_ORDINAL = 35
SEED = 0
...
O1C104_DERIVED_RECEIPT_RELATIVE = (
    PUBLISHED_PREPARATION_RELATIVE / O1C104_DERIVED_RECEIPT_NAME
)
O1C104_DERIVED_CLOSURE_RELATIVE = (
    PUBLISHED_PREPARATION_RELATIVE / O1C104_DERIVED_CLOSURE_NAME
)
O1C104_DERIVED_OVERLAY_RELATIVE = (
    PUBLISHED_PREPARATION_RELATIVE / O1C104_DERIVED_OVERLAY_NAME
)
DERIVED_NAMESPACE_SHA256_FIELDS: Mapping[str, str] = {
    "inherited_derived_resolution_receipt_sha256": (INHERITED_DERIVED_RECEIPT_SHA256),
    "inherited_derived_resolution_closure_sha256": (INHERITED_DERIVED_CLOSURE_SHA256),
    "inherited_derived_resolution_overlay_sha256": (INHERITED_DERIVED_OVERLAY_SHA256),
    "o1c104_derived_resolution_receipt_sha256": O1C104_DERIVED_RECEIPT_SHA256,
    "o1c104_derived_resolution_closure_sha256": O1C104_DERIVED_CLOSURE_SHA256,
    "o1c104_derived_resolution_overlay_sha256": O1C104_DERIVED_OVERLAY_SHA256,
    "new_o1c108_derived_resolution_receipt_sha256": DERIVED_RECEIPT_SHA256,
    "new_o1c108_derived_resolution_closure_sha256": DERIVED_CLOSURE_SHA256,
    "new_o1c108_derived_resolution_overlay_sha256": DERIVED_OVERLAY_SHA256,
}
...
INPUT_BANK_TOTAL_COUNT = 416_094
PARENT_CENTERED_ACTION_CAPACITY = 256

NATIVE_V33_USAGE = (
    b"usage: cadical_o1_joint_score_sieve_v33 --cnf PATH "
...
PUBLISHED_ARTIFACT_SEALS: Mapping[str, tuple[int, str, str]] = (
    _native_v36.O1C108_ARTIFACT_SEALS
)

SOURCE_PATHS = {
    "runner": "src/o1_crypto_lab/o1c109_apple8_parent_centered_continuation_run.py",
    "runner_tests": "tests/test_o1c109_apple8_parent_centered_continuation_run.py",
    "adapter_v36": "src/o1_crypto_lab/joint_score_sieve_v36.py",
    "adapter_v36_tests": "tests/test_joint_score_sieve_v36.py",
    ...
    "page22_type_safe_rollover_preparation": "src/o1_crypto_lab/o1c108_page22_type_safe_causal_rollover_prepare.py",
    "page22_type_safe_rollover_preparation_tests": "tests/test_o1c108_page22_type_safe_causal_rollover_prepare.py",
    ...
    "native_v33": "native/cadical_o1_joint_score_sieve_v33.cpp",
    "native_v33_tests": "tests/test_cadical_o1_joint_score_sieve_v33.py",
...
NATIVE_ARCHIVE_NAMES = (
    ...
    "local-prunable-breadcrumbs.json",
    "base-sieve.json",
    "vault.json",
    "resources.json",
    FINAL_BANK_NAME,
...
class O1C109RunError(RuntimeError):
...
class PreflightBundle:
    ...
    o1c104_derived_receipt: bytes
    o1c104_derived_closure: bytes
    o1c104_derived_overlay: bytes
...
def _mapping(value: object, field: str) -> Mapping[str, object]:
    if not isinstance(value, Mapping) or not all(isinstance(k, str) for k in value):
        raise O1C109RunError(f"{field} differs")
...
def _relative_text(value: object, field: str) -> str:
    ...
    if path.is_absolute() or not path.parts or ".." in path.parts:
        raise O1C109RunError(f"{field} escapes the lab")
...
def _lab_path(
    ...
    try:
        ...
        raise O1C109RunError(f"{field} cannot be resolved") from exc
    expected = (
    ...
    if (
        ...
        raise O1C109RunError(f"{field} is not a canonical lab path")
    return resolved


def _external_path(value: object, field: str, *, directory: bool = False) -> Path:
    if not isinstance(value, str) or not Path(value).is_absolute():
        raise O1C109RunError(f"{field} is not absolute")
    ...
    if stat.S_ISLNK(metadata.st_mode) or not expected:
        raise O1C109RunError(f"{field} is not canonical")
    return resolved
...
def _read_canonical_json(path: Path, field: str) -> Mapping[str, object]:
    ...
    try:
        ...
        raise O1C109RunError(f"{field} is not JSON") from exc
    if canonical_json_bytes(value) != payload:
        raise O1C109RunError(f"{field} is not canonical JSON")
    return value


def _atomic_create(path: Path, payload: bytes, *, mode: int = 0o444) -> None:
    if not isinstance(payload, bytes):
        raise O1C109RunError("atomic payload differs")
    ...
    try:
        ...
        if path.read_bytes() != payload:
            raise O1C109RunError(f"atomic write verification failed for {path.name}")
        path.chmod(mode)
        ...
        raise O1C109RunError(f"artifact already exists: {path.name}") from exc
...
def load_config(path: str | Path, *, root: Path | None = None) -> dict[str, object]:
    ...
    if not config_path.is_relative_to(lab) or config_path.is_symlink():
        raise O1C109RunError("config escapes the lab")
    config = dict(_read_canonical_json(config_path, "O1C109 config"))
    if _pending(config):
        raise O1C109RunError("config contains PENDING: " + ", ".join(_pending(config)))
    if (
        set(config)
        != {
            "schema",
        ...
        raise O1C109RunError("config fields differ")
    ...
    if (
        ...
        raise O1C109RunError("frozen O1C107 parent differs")
    ...
    if (
        ...
        != {
            ...
            "o1c104_derived_resolution_receipt",
            "o1c104_derived_resolution_receipt_sha256",
            "o1c104_derived_resolution_receipt_bytes",
            "o1c104_derived_resolution_closure",
            "o1c104_derived_resolution_closure_sha256",
            "o1c104_derived_resolution_closure_bytes",
            "o1c104_derived_resolution_overlay",
            "o1c104_derived_resolution_overlay_sha256",
            "o1c104_derived_resolution_overlay_bytes",
        ...
        or _relative_text(
            preparation.get("o1c104_derived_resolution_receipt"),
            "O1C104 derived resolution receipt",
        )
        != O1C104_DERIVED_RECEIPT_RELATIVE.as_posix()
        or preparation.get("o1c104_derived_resolution_receipt_sha256")
        != O1C104_DERIVED_RECEIPT_SHA256
        or preparation.get("o1c104_derived_resolution_receipt_bytes")
        != O1C104_DERIVED_RECEIPT_BYTES
        or _relative_text(
            preparation.get("o1c104_derived_resolution_closure"),
            "O1C104 derived resolution closure",
        )
        != O1C104_DERIVED_CLOSURE_RELATIVE.as_posix()
        or preparation.get("o1c104_derived_resolution_closure_sha256")
        != O1C104_DERIVED_CLOSURE_SHA256
        or preparation.get("o1c104_derived_resolution_closure_bytes")
        != O1C104_DERIVED_CLOSURE_BYTES
        or _relative_text(
            preparation.get("o1c104_derived_resolution_overlay"),
            "O1C104 derived resolution overlay",
        )
        != O1C104_DERIVED_OVERLAY_RELATIVE.as_posix()
        or preparation.get("o1c104_derived_resolution_overlay_sha256")
        != O1C104_DERIVED_OVERLAY_SHA256
        or preparation.get("o1c104_derived_resolution_overlay_bytes")
        ...
        raise O1C109RunError("frozen preparation source differs")
    ...
    if set(inputs) != {
        ...
        raise O1C109RunError("input fields differ")
    ...
    if (
        ...
        or native.get("adapter_schema") != _native_v36.JOINT_SCORE_SIEVE_ADAPTER_SCHEMA
        or native.get("result_schema") != _native_v36.JOINT_SCORE_SIEVE_RESULT_SCHEMA
        or native.get("page22_sha256") != PAGE22_SHA256
        or native.get("page22_bytes") != PAGE22_SERIALIZED_BYTES
    ...
    if dict(paths) != SOURCE_PATHS or set(digests) != set(SOURCE_PATHS):
        raise O1C109RunError("source inventory differs")
    ...
    if dict(budgets) != expected_budgets:
        raise O1C109RunError("budgets differ")
    return config
...
def _sibling_solver_pids() -> tuple[int, ...]:
    try:
        ...
        raise O1C109RunError("solver process census failed") from exc
    current = os.getpid()
    found: list[int] = []
...
def _validate_priority_receipt(payload: bytes, bank: bytes) -> Mapping[str, object]:
    try:
        ...
        raise O1C109RunError("priority state receipt is not JSON") from exc
    if canonical_json_bytes(receipt) != payload:
        raise O1C109RunError("priority state receipt is not canonical JSON")
    hexadecimal = receipt.get("bank_hex")
    try:
        receipt_bank = bytes.fromhex(cast(str, hexadecimal))
    except (TypeError, ValueError) as exc:
        raise O1C109RunError("priority state receipt bank differs") from exc
    if (
        receipt.get("schema")
        ...
        raise O1C109RunError("priority state receipt contract differs")
    return receipt
...
def _validate_occurrence_ledger(payload: bytes) -> frozenset[str]:
    ...
    if (
        ...
        raise O1C109RunError("published occurrence ledger contract differs")
    ...
    for ordinal, value in enumerate(records):
        ...
        if (
            ...
            raise O1C109RunError("published occurrence record differs")
    ...
    if (
        ...
        or sha256_bytes(canonical_json_bytes(ordered)) != EMITTED_KNOWN_INVENTORY_SHA256
    ):
        raise O1C109RunError("published attic union digest inventory differs")
    return digests
...
def _validate_logical_known_inventory(
    ...
    prior_row = _mapping(registry.get("prior_prefix"), "published prior registry")
    native_row = _mapping(registry.get("new_native"), "published native registry")
    ...
    prior_order = combined_order[:2692]
    native_order = combined_order[2692:2958]
    new_order = combined_order[2958:3111]
    logical = frozenset(combined_order)
    if (
        len(combined_order) != LOGICAL_KNOWN_CLAUSE_COUNT
        or len(logical) != LOGICAL_KNOWN_CLAUSE_COUNT
        or len(prior_order) != 2692
        or len(native_order) != 266
        or len(new_order) != 153
        or len(emitted) != ATTIC_UNION_CLAUSE_COUNT
        or not emitted.issubset(logical)
        or registry.get("registry_segment_order")
        != [
            "o1c106-logical-known-registry-byte-order",
            "new-o1c107-native-emission",
            "new-o1c108-derived-resolution",
        ]
        or prior_row.get("clause_count") != 2692
        or prior_row.get("inventory_sha256")
        ...
        != {
            ...
            "stop_exclusive": 2958,
            "clause_count": 266,
            "inventory_sha256": _o1c108.NEW_CHUNK_INVENTORY_SHA256,
        }
        or new_row
        != {
            "start": 2958,
            "stop_exclusive": 3111,
            "clause_count": 153,
            "inventory_sha256": DERIVED_KNOWN_INVENTORY_SHA256,
        }
        or len(logical) != LOGICAL_KNOWN_CLAUSE_COUNT
        or combined_row.get("inventory_sha256") != COMBINED_KNOWN_INVENTORY_SHA256
        or sha256_bytes(canonical_json_bytes(prior_order))
        != _o1c104.LOGICAL_KNOWN_INVENTORY_SHA256
        or sha256_bytes(canonical_json_bytes(native_order))
        ...
        raise O1C109RunError("published logical known inventory differs")
    return logical


def _validate_published_documents(artifacts: Mapping[str, bytes]) -> frozenset[str]:
    """Validate all sealed proof namespaces and the full logical registry."""

    _validate_priority_receipt(
        artifacts[RECEIPT_NAME], artifacts[CONTINUATION_BANK_NAME]
    )
    _native_v36._validate_inherited_derived_receipt(
        artifacts[INHERITED_DERIVED_RECEIPT_NAME]
    )
    _native_v36._validate_o1c104_derived_receipt(
        artifacts[O1C104_DERIVED_RECEIPT_NAME]
    )
    _native_v36._validate_o1c108_derived_receipt(artifacts[DERIVED_RECEIPT_NAME])
    if artifacts[DERIVED_CLOSURE_NAME] != artifacts[DERIVED_OVERLAY_NAME]:
        raise O1C109RunError("published O1C108 closure/overlay equality differs")
    ...
    certification = _canonical_payload(
        artifacts[CERTIFICATION_AUDIT_NAME], "published Page-22 certification"
    )
    ...
    projection = _mapping(
        residency.get("current_projection"), "published Page-22 projection"
    )
    encoding = _mapping(
        projection.get("encoding_only"), "published Page-22 encoding"
    )
    active_rows = _sequence(
        certification.get("active_rows_in_serialization_order"),
        "published Page-22 certification rows",
    )
    if (
        activation.get("schema") != _o1c108.COMPOSED_ACTIVATION_SCHEMA
        or residency.get("schema") != _o1c108.COMPOSED_RESIDENCY_SCHEMA
        or residency.get("lineage_ordinal") != LINEAGE_CALL_ORDINAL
        or residency.get("active_limit") != PAGE22_ACTIVE_LIMIT
        or encoding.get("sha256") != PAGE22_SHA256
        or encoding.get("clause_count") != PAGE22_CLAUSE_COUNT
        or encoding.get("literal_count") != PAGE22_LITERAL_COUNT
        or encoding.get("serialized_bytes") != PAGE22_SERIALIZED_BYTES
        ...
        or certification.get("schema") != _o1c108.CERTIFICATION_AUDIT_SCHEMA
        or certification.get("attempt_id") != "O1C-0108"
        or certification.get("passed") is not True
        or len(active_rows) != PAGE22_CLAUSE_COUNT
        or relations.get("strict_subsumption_pair_count")
        != ATTIC_SUBSUMPTION_RELATION_COUNT
        or relations.get("undominated_clause_count")
        != ATTIC_UNDOMINATED_CLAUSE_COUNT
    ):
        raise O1C109RunError("published composed Page-22 contract differs")
...
def _validate_native_capacity_proof(value: object) -> Mapping[str, object]:
    """Derive and verify the exact Page-22 native-capacity proof before intent."""

    page = _mapping(value, "published Page-22 capacity source")
    expected_caps = {
        "maximum_clauses": 512,
        "maximum_literals": 1_600_000,
        "maximum_serialized_bytes": 8_388_608,
    }
    headroom = _mapping(page.get("headroom"), "published Page-22 headroom")
    input_clauses = _nonnegative(page.get("clause_count"), "Page-22 input clauses")
    additional = _nonnegative(headroom.get("clauses"), "Page-22 clause headroom")
    if (
        O1C66_VAULT_CAPS.describe() != expected_caps
        or input_clauses != PAGE22_CLAUSE_COUNT
        or additional != PAGE22_HEADROOM["clauses"]
        or dict(headroom) != PAGE22_HEADROOM
        or input_clauses + additional != expected_caps["maximum_clauses"]
        or additional < PARENT_CENTERED_ACTION_CAPACITY
    ):
        raise O1C109RunError("published Page-22 native capacity proof differs")
    proof: dict[str, object] = {
        "caps": expected_caps,
        "clause_headroom_guarantee": {
            "native_vault_maximum_clauses": expected_caps["maximum_clauses"],
            "page22_input_clauses": input_clauses,
        ...
        "recorded_residual_headroom": {
            "literals": PAGE22_HEADROOM["literals"],
            "serialized_bytes": PAGE22_HEADROOM["serialized_bytes"],
        },
...
def _disabled_o1c96_published_manifest_validator(
    ...
    if (
        ...
        raise O1C109RunError("published preparation manifest identity differs")
    ...
    page22 = _mapping(manifest.get("page22"), "published Page-16")
    _validate_native_capacity_proof(page22)
    ...
    if dict(zero_call) != {
        ...
        raise O1C109RunError("published zero-call authorization differs")
    if (
        ...
        raise O1C109RunError("published parent boundary differs")
    if (
        ...
        raise O1C109RunError("published rollover/attic boundary differs")
    if (
        page22.get("lineage_ordinal") != LINEAGE_CALL_ORDINAL
        or page22.get("active_limit") != PAGE22_ACTIVE_LIMIT
        or page22.get("active_sha256") != PAGE22_SHA256
        or page22.get("clause_count") != PAGE22_CLAUSE_COUNT
        or page22.get("literal_count") != PAGE22_LITERAL_COUNT
        or page22.get("serialized_bytes") != PAGE22_SERIALIZED_BYTES
        or page22.get("category_counts") != PAGE22_CATEGORY_COUNTS
        or page22.get("headroom") != PAGE22_HEADROOM
        or page22.get("fresh_identity") is not True
    ):
        raise O1C109RunError("published Page-16 seal differs")
    if (
        ...
        raise O1C109RunError("published continuation bank seal differs")
    rows_raw = _mapping(manifest.get("artifacts"), "published artifact rows")
    if set(rows_raw) != set(PUBLISHED_ARTIFACT_SEALS):
        raise O1C109RunError("published artifact row inventory differs")
    ...
    for name, (size, digest, role) in PUBLISHED_ARTIFACT_SEALS.items():
        ...
        if (
            ...
            raise O1C109RunError("published artifact seal differs")
        rows[name] = row
    ...
    raise O1C109RunError("historical manifest validator is disabled")


def _validate_published_manifest(
    manifest: Mapping[str, object], artifacts: Mapping[str, bytes]
) -> tuple[dict[str, Mapping[str, object]], frozenset[str]]:
    """Validate the exact O1C108 bundle and all 3,111 logical identities."""

    payload = canonical_json_bytes(manifest)
    _native_v36._validate_o1c108_manifest(payload)
    if (
        manifest.get("schema") != PREPARATION_SCHEMA
        or manifest.get("attempt_id") != "O1C-0108"
        or set(artifacts) != PREPARATION_ARTIFACT_NAMES
        or PREPARATION_MANIFEST_NAME not in artifacts
    ):
        raise O1C109RunError("published O1C108 Page-22 boundary differs")
    page22 = _mapping(manifest.get("page22"), "published Page-22")
    capacity = _validate_native_capacity_proof(page22)
    if capacity["clause_headroom_guarantee"] != {
        "native_vault_maximum_clauses": 512,
        "page22_input_clauses": 246,
        "maximum_additional_clauses_before_capacity_terminal": 266,
        "parent_centered_action_capacity": 256,
        "spare_clause_slots_beyond_action_capacity": 10,
        "proved_sufficient": True,
    }:
        raise O1C109RunError("published Page-22 native capacity differs")
...
def _load_published_preparation(
    ...
    try:
        ...
        raise O1C109RunError("published preparation inventory is unreadable") from exc
    if (
        manifest_path != directory / PREPARATION_MANIFEST_NAME
        or {path.name for path in children} != PREPARATION_ARTIFACT_NAMES
    ):
        raise O1C109RunError("published preparation inventory differs")
    ...
    for path in children:
        try:
            ...
            raise O1C109RunError(
                "published preparation artifact is unreadable"
            ) from exc
        if stat.S_ISLNK(metadata.st_mode) or not stat.S_ISREG(metadata.st_mode):
            raise O1C109RunError("published preparation artifact type differs")
    ...
    if (
        ...
        raise O1C109RunError("published preparation manifest seal differs")
...
def _preflight_bundle(
    ...
    *,
    ...
    if (
        ...
        raise O1C109RunError("parent input SHA preflight differs")
    ...
    o1c104_receipt_path = _lab_path(
        root,
        preparation["o1c104_derived_resolution_receipt"],
        "O1C104 derived resolution receipt",
    )
    o1c104_closure_path = _lab_path(
        root,
        preparation["o1c104_derived_resolution_closure"],
        "O1C104 derived resolution closure",
    )
    o1c104_overlay_path = _lab_path(
        root,
        preparation["o1c104_derived_resolution_overlay"],
        "O1C104 derived resolution overlay",
    )
    ...
    if (
        ...
        or o1c104_receipt_path.stat().st_size
        != preparation["o1c104_derived_resolution_receipt_bytes"]
        or _sha_file(o1c104_receipt_path)
        != preparation["o1c104_derived_resolution_receipt_sha256"]
        or o1c104_closure_path.stat().st_size
        != preparation["o1c104_derived_resolution_closure_bytes"]
        or _sha_file(o1c104_closure_path)
        != preparation["o1c104_derived_resolution_closure_sha256"]
        or o1c104_overlay_path.stat().st_size
        != preparation["o1c104_derived_resolution_overlay_bytes"]
        or _sha_file(o1c104_overlay_path)
        != preparation["o1c104_derived_resolution_overlay_sha256"]
        ...
        raise O1C109RunError("published preparation/receipt preflight differs")
    ...
    for name in ("cnf", "potential", "grouping", "o1c73_config"):
        ...
        if observed != inputs[f"{name}_sha256"]:
            raise O1C109RunError(f"input {name} SHA preflight differs")
        input_sha[name] = observed
        input_paths[name] = candidate
    ...
    for name in SOURCE_PATHS:
        ...
        if observed != expected[name]:
            raise O1C109RunError(f"source {name} SHA preflight differs")
    ...
    if (
        ...
        or source_sha["native_v33"] != native["source_sha256"]
    ):
        raise O1C109RunError("native toolchain/source SHA preflight differs")

    prepared = _load_published_preparation(published_directory, published_manifest)
    page22_manifest = _mapping(
        prepared.manifest.get("page22"), "published Page-22 preflight"
    )
    capacity_proof = _validate_native_capacity_proof(page22_manifest)
    prepared_rows = {
        name: {
    ...
    o1c104_receipt_payload = o1c104_receipt_path.read_bytes()
    o1c104_closure_payload = o1c104_closure_path.read_bytes()
    o1c104_overlay_payload = o1c104_overlay_path.read_bytes()
    ...
    _native_v36._validate_inherited_derived_receipt(inherited_receipt_payload)
    _native_v36._validate_o1c104_derived_receipt(o1c104_receipt_payload)
    _native_v36._validate_o1c108_derived_receipt(new_receipt_payload)
    expected_derived_payloads = {
        ...
        O1C104_DERIVED_RECEIPT_NAME: o1c104_receipt_payload,
        O1C104_DERIVED_CLOSURE_NAME: o1c104_closure_payload,
        O1C104_DERIVED_OVERLAY_NAME: o1c104_overlay_payload,
    ...
    if any(
        ...
        raise O1C109RunError("derived namespace publication linkage differs")
    try:
        _native_v36.validate_o1c109_page22_inputs(
            bundle_dir=published_directory,
            cnf_path=input_paths["cnf"],
            potential_path=input_paths["potential"],
            grouping_path=input_paths["grouping"],
            vault_path=published_directory / ACTIVE_PROJECTION_NAME,
            vault_caps=O1C66_VAULT_CAPS,
            threshold=THRESHOLD,
        )
    except Exception as exc:
        raise O1C109RunError(
            "real Page-22 v8 input certification failed before intent"
        ) from exc
    ...
    if (
        ...
        raise O1C109RunError("Darwin/arm64/RAM/disk/process preflight differs")
    row = {
        ...
        "published_preparation": {
            ...
            "real_v8_input_certification_verified_before_intent": True,
        },
        "page22_sha256": PAGE22_SHA256,
        ...
        "o1c104_derived_resolution_triplet": {
            "receipt": prepared_rows[O1C104_DERIVED_RECEIPT_NAME],
            "closure": prepared_rows[O1C104_DERIVED_CLOSURE_NAME],
            "overlay": prepared_rows[O1C104_DERIVED_OVERLAY_NAME],
        },
    ...
    return PreflightBundle(
        ...
        o1c104_derived_receipt=o1c104_receipt_payload,
        o1c104_derived_closure=o1c104_closure_payload,
        o1c104_derived_overlay=o1c104_overlay_payload,
...
def _executable_identity(path: Path, *, relative_path: str) -> dict[str, object]:
    try:
        ...
        raise O1C109RunError("native executable is unreadable") from exc
    if stat.S_ISLNK(metadata.st_mode) or not stat.S_ISREG(metadata.st_mode):
        raise O1C109RunError("native executable type differs")
    size = path.stat().st_size
    if size <= 0:
        raise O1C109RunError("native executable is empty")
    return {
        "path": relative_path,
...
def _verify_staged_native_closure(
    *,
    ...
    if len(expected_files) != len(NATIVE_CLOSURE_NAMES):
        raise O1C109RunError("staged native closure basenames collide")
    ...
    try:
        ...
        for candidate in closure_root.rglob("*"):
            ...
            if stat.S_ISLNK(metadata.st_mode):
                raise O1C109RunError("staged native closure contains a symlink")
            if stat.S_ISDIR(metadata.st_mode):
                observed_directories.add(relative)
                if stat.S_IMODE(metadata.st_mode) != 0o555:
                    raise O1C109RunError("staged native closure directory is writable")
            elif stat.S_ISREG(metadata.st_mode):
                observed_files.add(relative)
                if stat.S_IMODE(metadata.st_mode) != 0o444:
                    raise O1C109RunError("staged native closure file is writable")
            else:
                raise O1C109RunError("staged native closure contains a special file")
    except OSError as exc:
        raise O1C109RunError("staged native closure is unreadable") from exc
    if (
        ...
        raise O1C109RunError("staged native closure inventory differs")
    ...
    for name in NATIVE_CLOSURE_NAMES:
        ...
        if row["sha256"] != digests.get(name):
            raise O1C109RunError(f"staged native closure {name} digest differs")
        rows.append(row)
    normalized_expected = [
        dict(_mapping(value, "expected staged closure row")) for value in expected_rows
    ]
    if rows != normalized_expected:
        raise O1C109RunError("staged native closure rows differ")
    return rows
    ...
    *,
    ...
    for name in NATIVE_CLOSURE_NAMES:
        ...
        if approved_source_sha256.get(name) != expected_sha:
            raise O1C109RunError("native closure preflight/config seal differs")
        source_path = _lab_path(root, configured, f"native closure {name}")
        payload = source_path.read_bytes()
        if sha256_bytes(payload) != expected_sha:
            raise O1C109RunError(f"native closure {name} changed after preflight")
...
def _compile_native(
    *,
    ...
    staged_source = _relative_text(source_paths["native_v33"], "staged v33 source")
    if (
        native["source"] != staged_source
        or _mapping(verified_closure[0], "staged v33 row").get("sha256")
        != native["source_sha256"]
        or _sha_file(library) != native["cadical_library_sha256"]
    ):
        raise O1C109RunError("native build input changed after preflight")
    ...
    try:
        ...
        raise O1C109RunError("native v33 compilation could not run") from exc
    ...
    try:
        ...
        raise O1C109RunError("native v33 --help smoke could not run") from exc
    ...
    if (
        ...
        or smoke_stdout != NATIVE_V33_USAGE
        or smoke_stderr
        or after_smoke != before_smoke
    ):
        raise O1C109RunError("native v33 --help smoke seal differs")
    verified_closure = _verify_staged_native_closure(
        stage=stage,
        config=config,
        expected_rows=closure_rows,
    ...
    if _sha_file(library) != native["cadical_library_sha256"]:
        raise O1C109RunError("native library changed during build/smoke")
    normalized_command = [
        *command[:-1],
    ...
    build = {
        ...
        "staged_source": dict(_mapping(verified_closure[0], "staged v33 row")),
...
def _validate_staged_native_build(
    *,
    ...
    if (
        ...
        or smoke.get("stdout")
        != {
            "serialized_bytes": len(NATIVE_V33_USAGE),
            "sha256": sha256_bytes(NATIVE_V33_USAGE),
        }
        or smoke.get("stderr") != {"serialized_bytes": 0, "sha256": sha256_bytes(b"")}
        or smoke.get("executable") != executable
    ):
        raise O1C109RunError("staged native build provenance differs")
...
def _stage_capsule(
    *,
    ...
    if final.exists() or stage.exists():
        raise O1C109RunError("timestamped capsule already exists")
    ...
    try:
        ...
        if sha256_bytes(config_payload) != bundle.row.get(
            ...
            raise O1C109RunError("config changed before closure snapshot")
...
def _rehash_call_inputs(
    *,
    ...
    if _sha_file(config_path) != preflight_row.get("config_sha256"):
        raise O1C109RunError("config changed before native call")
    ...
    for name in ("cnf", "potential", "grouping", "o1c73_config"):
        if (
            ...
            raise O1C109RunError(f"input {name} changed before native call")
    ...
    o1c104_triplet = _mapping(
        preflight_row.get("o1c104_derived_resolution_triplet"),
        "approved O1C104 derived triplet",
    )
    new_triplet = _mapping(
        preflight_row.get("new_derived_resolution_triplet"),
        "approved new derived triplet",
    )
    if prepared_rows.get(RECEIPT_NAME) != receipt_row or invocation.get(
        "priority_state_receipt_sha256"
    ) != receipt_row.get("sha256"):
        raise O1C109RunError("staged receipt seal differs")
    triplet_contract = (
        (
            inherited_triplet,
            "receipt",
        ...
        (
            ...
            "receipt",
            DERIVED_RECEIPT_NAME,
            "new_o1c108_derived_resolution_receipt_sha256",
        ),
        (
            new_triplet,
            "closure",
            DERIVED_CLOSURE_NAME,
            "new_o1c108_derived_resolution_closure_sha256",
        ),
        (
            new_triplet,
            "overlay",
            DERIVED_OVERLAY_NAME,
            "new_o1c108_derived_resolution_overlay_sha256",
        ),
    )
    for triplet, component, artifact_name, invocation_field in triplet_contract:
        ...
        if prepared_rows.get(artifact_name) != row or invocation.get(
            invocation_field
        ) != row.get("sha256"):
            raise O1C109RunError("staged derived namespace seal differs")
    ...
    for name, value in expected_rows.items():
        ...
        if path.stat().st_size != row.get("serialized_bytes") or _sha_file(
            ...
            raise O1C109RunError("staged call artifact seal differs")
    ...
    if (
        ...
        raise O1C109RunError("staged invocation/build seal differs")
    ...
    if (
        ...
        raise O1C109RunError("staged native build/smoke seal differs")
    if require_executable_identity:
        _require_executable_identity(
...
def _native_stdout(result: object) -> bytes:
    ...
    if isinstance(value, str):
        ...
        raise O1C109RunError("adapter omitted byte-exact native stdout")
    if _sha(
        getattr(result, "native_stdout_sha256", None), "native stdout digest"
    ) != sha256_bytes(payload):
        raise O1C109RunError("native stdout digest differs")
    return payload
...
def _validate_result_conservation(
    ...
    if set(counters) != {*outcome_names, "child_bound_evaluations"}:
        raise O1C109RunError("native post-result conservation differs")
    outcomes = tuple(
...
def _adapter_memory_samples(
    ...
    for raw in rows_raw:
        ...
        if (
            ...
            raise O1C109RunError("adapter memory sample differs")
    ...
    if (
        ...
        != _native_v36._v9.JOINT_SCORE_SIEVE_MEMORY_SERIES_SCHEMA
        or memory.get("memory_sample_limit")
        != _native_v36._v9.JOINT_SCORE_SIEVE_MAXIMUM_MEMORY_SAMPLES
        ...
        raise O1C109RunError("adapter memory ledger differs")
    return tuple(rows)


def _validate_native_result(result: object, stdout: bytes) -> NativeEvidence:
    if not isinstance(result, _native_v36.JointScoreSieveV36Result):
        raise O1C109RunError("adapter v36 result type differs")
    ...
    try:
        ...
        raise O1C109RunError("native stdout JSON differs") from exc
    if (
        decoded != raw
        or raw.get("schema") != _native_v36.JOINT_SCORE_SIEVE_RESULT_SCHEMA
    ):
        raise O1C109RunError("native stdout/result projection differs")
    ...
    breadcrumbs = _mapping(
        result.local_prunable_breadcrumbs, "local-prunable breadcrumbs"
    )
    _native_v36._validate_local_prunable_breadcrumbs(breadcrumbs)
    _native_v36._validate_breadcrumb_probe_linkage(breadcrumbs, priority_state)
    ...
    if (
        ...
        or raw.get("active_vault_sha256") != PAGE22_SHA256
        ...
        raise O1C109RunError("native v33 production binding differs")
    if (
        raw.get("priority_state") != priority_state
        or raw.get("priority_actions") != actions
    ):
        raise O1C109RunError("native promoted priority projection differs")
    if raw.get("decision_ownership") != ownership:
        raise O1C109RunError("native promoted ownership projection differs")
    if raw.get("local_prunable_breadcrumbs") != breadcrumbs:
        raise O1C109RunError("native promoted breadcrumb projection differs")
    if result.status == 10 and not isinstance(result.key_model, bytes):
        raise O1C109RunError("SAT result omitted key model")
    if result.status != 10 and result.key_model is not None:
        raise O1C109RunError("non-SAT result returned key model")
...
def _science_and_operation(
    ...
    *,
    ...
    if action_count != len(actions):
        raise O1C109RunError("priority action count differs")
    ...
    for row in emitted_rows:
        ...
        try:
            ...
            raise O1C109RunError("emitted clause serialization differs") from exc
    ...
    if novel > active_new:
        raise O1C109RunError("global novelty exceeds active-vault novelty")
    ...
    if evidence.status == 10 and not public_model_verified:
        raise O1C109RunError("SAT key failed exact public ChaCha verification")
    if evidence.status != 10 and public_model_verified:
        raise O1C109RunError("public model verification without SAT differs")
    model_gain = evidence.status == 10 and public_model_verified
    closure_gain = evidence.status == 20 or terminal_empty
    breadcrumbs = _native_v36._validate_local_prunable_breadcrumbs(
        evidence.local_prunable_breadcrumbs
    )
    breadcrumb_rows = tuple(
        _mapping(row, "local-prunable breadcrumb")
        for row in _sequence(breadcrumbs.get("breadcrumbs"), "breadcrumb rows")
    )
    breadcrumb_classes = dict(
        _mapping(breadcrumbs.get("class_counts"), "breadcrumb class counts")
    )
    retained_consumed = sum(
        row.get("consumed_before") is True for row in breadcrumb_rows
    )
    retained_crossing_eligible = sum(
        row.get("crossing_eligible") is True for row in breadcrumb_rows
    )
    # Native v33 emits no entropy or domain estimate.  These fields stay
    ...
    operation = {
        ...
        "local_prunable_breadcrumbs": {
            "total_match_count": breadcrumbs["total_match_count"],
            "retained_count": breadcrumbs["retained_count"],
            "overflow_count": breadcrumbs["overflow_count"],
            "complete": breadcrumbs["complete"],
            "class_counts": breadcrumb_classes,
            "retained_consumed_before_count": retained_consumed,
            "retained_crossing_eligible_count": retained_crossing_eligible,
            "affects_action_selection": False,
            "is_science_gain": False,
            "is_key_bit_belief": False,
        },
    }
    science = {
        ...
        "active_page22_new_clauses": active_new,
    ...
    *,
    ...
    try:
        ...
        result = adapter_run(
            ...
            rollover_bundle_dir=capsule / "initial",
        )
        ...
        # Adapter v36 attaches the completed process record even when semantic
...
def _manifest_bytes(capsule: Path) -> tuple[bytes, int]:
    ...
    for path in sorted(capsule.rglob("*")):
        metadata = path.lstat()
        if stat.S_ISLNK(metadata.st_mode):
            raise O1C109RunError("capsule contains a symlink")
        if stat.S_ISDIR(metadata.st_mode):
            continue
        if not stat.S_ISREG(metadata.st_mode):
            raise O1C109RunError("capsule contains a special file")
...
def _run_markdown(result: Mapping[str, object]) -> bytes:
    ...
    lines = [
        "# O1C-0109 Page-22 parent-centered run",
        "",
        ...
        "- Page 22 and lineage 35 burned when `episodes/00/intent.json` was persisted.",
...
def _publish_exact(path: Path, payload: bytes) -> None:
    if path.exists():
        if path.is_symlink() or not path.is_file() or path.read_bytes() != payload:
            raise O1C109RunError("authoritative result already differs")
        return
...
def _finalize_capsule(
    *, capsule: Path, authoritative: Path, result: Mapping[str, object]
    ...
    if persistent_bytes > MAXIMUM_PERSISTENT_ARTIFACT_BYTES:
        raise O1C109RunError("persistent artifact budget exceeded")
...
def _existing_result(root: Path) -> dict[str, object] | None:
    ...
    if not authoritative.exists():
        return None
    value = dict(_read_canonical_json(authoritative, "authoritative O1C109 result"))
    if value.get("schema") != RESULT_SCHEMA or value.get("attempt_id") != ATTEMPT_ID:
        raise O1C109RunError("authoritative O1C109 result differs")
    return value
...
def _validate_capsule_artifact_row(
    ...
    *,
    ...
    try:
        ...
        raise O1C109RunError(f"capsule artifact {name} is unreadable") from exc
    if stat.S_ISLNK(metadata.st_mode) or not stat.S_ISREG(metadata.st_mode):
        raise O1C109RunError(f"capsule artifact {name} type differs")
    expected = _artifact_row(path, relative_to=directory)
    if set(row) != {"path", "serialized_bytes", "sha256"} or row != expected:
        raise O1C109RunError(f"capsule artifact {name} seal differs")
    if canonical_json:
...
def _validated_timestamp(value: object, field: str) -> str:
    ...
    try:
        ...
        raise O1C109RunError(f"{field} differs") from exc
...
def _semantic_replay_completed_native(
    *,
    ...
    """Replay archived stdout through v36 using the original sealed inputs."""
    ...
    for name in ("cnf", "potential", "grouping"):
        ...
        if sha256_bytes(payload) != input_sha[name]:
            raise O1C109RunError(f"semantic replay {name} seal differs")
        payloads[name] = payload
    page22 = prepared.artifacts[ACTIVE_PROJECTION_NAME]
    bank = prepared.artifacts[CONTINUATION_BANK_NAME]
    if (
        len(page22) != PAGE22_SERIALIZED_BYTES
        or sha256_bytes(page22) != PAGE22_SHA256
        or len(bank) != CONTINUATION_BANK_BYTES
        or sha256_bytes(bank) != CONTINUATION_BANK_SHA256
    ):
        raise O1C109RunError("semantic replay Page22/bank seal differs")
    io_v1 = _native_v36._v9._v8._v7._v1
    try:
        field = io_v1._potential(payloads["potential"])
        grouping = _native_v36._v9.validate_joint_score_sieve_grouping(
            field, payloads["grouping"]
        )
        if grouping.potential_sha256 != input_sha["potential"]:
            raise O1C109RunError("semantic replay grouping identity differs")
        input_vault = _native_v36.parse_threshold_no_good_vault(
            page22,
            observed_variables=field.observed_variables,
            caps=O1C66_VAULT_CAPS,
        )
        identity = _native_v36.vault_identity_from_sources(
            cnf_sha256=input_sha["cnf"],
            potential_sha256=input_sha["potential"],
            grouping_sha256=input_sha["grouping"],
            observed_variables=field.observed_variables,
            bound_rule=_native_v36._v9.JOINT_SCORE_SIEVE_BOUND_RULE,
            threshold=THRESHOLD,
        )
        _native_v36.validate_threshold_no_good_vault_identity(
            input_vault, expected=identity
        )
        _native_v36._v9._v8._certify_input_vault(
            input_vault,
            field=field,
            grouping=grouping,
            threshold=THRESHOLD,
        )
        priority_records = _native_v36._decode_live_bank(
            bank,
            expected_sha256=CONTINUATION_BANK_SHA256,
            sealed_input=True,
        )
        memory_samples = _adapter_memory_samples(adapter_memory)
        raw = _native_v36._v21.load_native_json(stdout)
        replayed = _native_v36._parse_native_payload(
            raw,
        ...
        raise O1C109RunError("archived native semantic replay differs") from exc
    ...
    if replay_memory != adapter_memory:
        raise O1C109RunError("semantic replay adapter memory differs")
    ...
    *,
    ...
    if not all(path.is_file() and not path.is_symlink() for path in required):
        if (capsule / "episodes/00/intent.json").is_file():
            raise O1C109RunError("burned incomplete capsule forbids retry or replay")
        raise O1C109RunError("incomplete pre-intent capsule blocks a fresh call")
    manifest, _ = _manifest_bytes(capsule)
    if manifest != (capsule / "artifacts.sha256").read_bytes():
        raise O1C109RunError("existing capsule manifest differs")
    episode_dir = capsule / "episodes" / "00"
    ...
    try:
        ...
        raise O1C109RunError("existing capsule inventory is unreadable") from exc
    if (
        ...
        raise O1C109RunError("existing capsule inventory differs")
    ...
    if (
        ...
        raise O1C109RunError("existing capsule config differs")
    ...
    if (
        ...
        != {
            ...
            "real_v8_input_certification_verified_before_intent",
        }
        ...
        != _validate_native_capacity_proof(prepared.manifest["page22"])
        or published.get("native_capacity_proof_verified_before_intent") is not True
        or published.get("real_v8_input_certification_verified_before_intent")
        is not True
        or preflight.get("page22_sha256") != PAGE22_SHA256
        ...
        or preflight.get("o1c104_derived_resolution_triplet")
        != {
            "receipt": prepared_rows[O1C104_DERIVED_RECEIPT_NAME],
            "closure": prepared_rows[O1C104_DERIVED_CLOSURE_NAME],
            "overlay": prepared_rows[O1C104_DERIVED_OVERLAY_NAME],
        ...
        raise O1C109RunError("existing capsule preflight provenance differs")
    ...
    if (
        ...
        or invocation.get("page22_sha256") != PAGE22_SHA256
        ...
        raise O1C109RunError("existing capsule invocation provenance differs")
    _rehash_call_inputs(
        root=root,
        config_path=config_path,
        config=config,
    ...
    if (
        ...
        or intent.get("page22_sha256") != PAGE22_SHA256
        ...
        raise O1C109RunError("existing capsule burn intent differs")

    episode = dict(_read_canonical_json(episode_path, "capsule episode"))
    if episode != episode_preview:
        raise O1C109RunError("capsule episode changed during validation")
    ...
    if (
        ...
        raise O1C109RunError("existing capsule episode lineage differs")
    ...
    if episode.get("completed") is True:
        ...
        if (
            ...
            raise O1C109RunError("existing completed episode call contract differs")
        ...
        if set(archived) != set(NATIVE_ARCHIVE_NAMES):
            raise O1C109RunError("archived native component inventory differs")
        component_paths = {
        ...
        if episode.get("final_priority_bank") != archived[FINAL_BANK_NAME]:
            raise O1C109RunError("final priority bank row differs")
        ...
        try:
            raw = dict(_native_v36._v21.load_native_json(stdout))
        except Exception as exc:
            raise O1C109RunError("archived native stdout differs") from exc
        archived_raw = dict(
        ...
        local_prunable_breadcrumbs = dict(
            _read_canonical_json(
                component_paths["local-prunable-breadcrumbs.json"],
                "archived local-prunable breadcrumbs",
            )
        )
        base_sieve = dict(
            _read_canonical_json(
        ...
        if status == 10:
            if (
                ...
                raise O1C109RunError("archived SAT key model differs")
            if (
                len(key_model) != 32
                ...
                raise O1C109RunError("archived SAT key model is not publicly verified")
        elif status in (0, 20):
            if key_hex is not None or episode.get("key_model_sha256") is not None:
                raise O1C109RunError("archived non-SAT key model differs")
        else:
            raise O1C109RunError("archived native status differs")
        try:
            bank_hex = bytes.fromhex(cast(str, priority_state.get("bank_hex")))
        except (TypeError, ValueError) as exc:
            raise O1C109RunError("archived final bank encoding differs") from exc
        if (
            raw != archived_raw
            or evidence.raw != raw
            ...
            or evidence.local_prunable_breadcrumbs != local_prunable_breadcrumbs
            ...
            or raw.get("local_prunable_breadcrumbs")
            != local_prunable_breadcrumbs
            ...
            raise O1C109RunError("archived native result cross-binding differs")
        operation, science, classification, stop = _science_and_operation(
            evidence,
        ...
        if (
            ...
            raise O1C109RunError("completed episode science projection differs")
        ...
        if (
            ...
            raise O1C109RunError("terminal episode call count differs")
        if (
            ...
            raise O1C109RunError("terminal episode contract differs")
        ...
        if (
            ...
            or failure.get("page22_burned") is not True
            or failure.get("lineage35_burned") is not True
            ...
            raise O1C109RunError("terminal failure cross-binding differs")
        stdout_row = episode.get("native_stdout")
        if failure.get("native_stdout") != stdout_row:
            raise O1C109RunError("terminal native stdout row differs")
        if not native_inventory:
            if not (
                failure.get("phase") == "PRE_CALL"
                and failure.get("exception_type") == "O1C109RunError"
                ...
                raise O1C109RunError("missing terminal executable provenance differs")
        else:
            ...
            if observed_executable != executable and not (
                ...
                raise O1C109RunError("terminal executable provenance differs")
        expected_episode_inventory = {
            "intent.json",
            "episode.json",
        ...
        raise O1C109RunError("existing capsule episode completion differs")

    try:
        observed_episode_inventory = {path.name for path in episode_dir.iterdir()}
    except OSError as exc:
        raise O1C109RunError("episode inventory is unreadable") from exc
    if observed_episode_inventory != expected_episode_inventory:
        raise O1C109RunError("episode artifact inventory differs")
    ...
    if (
        ...
        != "Never retry or replay Page 22 / lineage 35 or Pages 21 through 9; preserve the final priority bank only as a continuation seed."
        or (capsule / "RUN.md").read_bytes() != _run_markdown(result)
    ):
        raise O1C109RunError("existing capsule result differs")
...
def _public_verifier(
    *, root: Path, config: Mapping[str, object]
    ...
    if _sha_file(config_path) != inputs["o1c73_config_sha256"]:
        raise O1C109RunError("public verifier config SHA differs")
    try:
        ...
        raise O1C109RunError("public ChaCha verifier cannot be established") from exc
...
def run(
    ...
    *,
    root: Path | None = None,
    adapter_run: AdapterRun = _native_v36.run_joint_score_sieve,
    ...
    if existing is not None:
        if len(capsules) != 1:
            raise O1C109RunError("authoritative O1C109 result lacks one sealed capsule")
        ...
        if capsule_payload != authoritative_payload or capsule_result != existing:
            raise O1C109RunError("authoritative O1C109 result differs from capsule")
        return existing
    if capsules:
        if len(capsules) != 1:
            raise O1C109RunError("multiple O1C109 capsules forbid replay")
    ...
    result = {
        ...
        "next_action": "Never retry or replay Page 22 / lineage 35 or Pages 21 through 9; preserve the final priority bank only as a continuation seed.",
    }
...
def _parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Preflight or execute O1C109's one Page-22 parent-centered call"
    )
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    try:
        ...
        return 0
    except O1C109RunError as exc:
        print(f"O1C109: {exc}", file=sys.stderr)
        return 2
