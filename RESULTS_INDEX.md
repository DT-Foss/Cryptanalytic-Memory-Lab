...
| `O1C-0019-HARNESS` | Artifact-only packet learner and autonomous BUILD-LOO picker gate | `INSTRUMENT` pre-run freeze | 4 symmetric folds; 5 policy + 2 raw-reader arms; W=16,384/32,768/49,152; key-lazy discovery; 29 tests + 5 subtests; two-process real-artifact micro-smoke reproduces scientific SHA `79648ab...f36a8` and both slot ledgers byte-exact; no scientific execution yet | [Frozen config](configs/full256_multiresolution_build_loo_v1.json) |
