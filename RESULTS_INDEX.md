...
or key, so phase-only gain fails. Preserve the sealed bytes, close replay/second
phase/phase-horizon/RAM scaling, and separately precommit a confidence-ranked
`cb_decide` variable-order operator.
