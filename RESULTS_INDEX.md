...
| `O1C-0026-ANCESTRY-PAIR` | Projected assumption-coordinate x ancestry-coordinate residual selected only by the authoritative post-result composer | `RETROSPECTIVE` conditional design only; no reservation/run/result | activates iff finalized O1C-0023 selects `proof_ancestry_pair_residual_v1`; otherwise exits without reservation; consumes no fresh target and cannot replace or tune the fixed decoder | [Design](research/O1C0026_PROOF_ANCESTRY_PAIR_RESIDUAL_DESIGN_20260718.md) |
